...
UPDATE taxa SET origin = '$ORIGIN_VALUE';
UPDATE observers SET origin = '$ORIGIN_VALUE';
UPDATE observations SET origin = '$ORIGIN_VALUE';
UPDATE photos SET origin = '$ORIGIN_VALUE';
...
# Add and update version columns
print_progress "Adding and updating version columns"
execute_sql "
BEGIN;
...
UPDATE photos SET version = '$VERSION_VALUE';
UPDATE observations SET version = '$VERSION_VALUE';
UPDATE observers SET version = '$VERSION_VALUE';
UPDATE taxa SET version = '$VERSION_VALUE';
