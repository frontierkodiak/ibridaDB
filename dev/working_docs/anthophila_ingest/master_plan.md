...
NOTE: this task was to backup `ibrida-v0-r1` and rename it to `ibrida-v0`. I think the above instruction was just caught in sloppy find-and-replace of `ibrida-v0-r1` string to `ibrida-v0`.
